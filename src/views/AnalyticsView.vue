    ...
    <div class="pt-12">
        <Card mb="lg:mb-12 mb-8">
            ...
            <div class="mb-6">
                ...
                <div v-else class="text-gray-400 text-sm">It's quiet here... Log your thoughts to see insights!</div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div v-else class="text-gray-400 text-sm">No categories logged yet. Start tracking your thoughts!</div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div v-else class="text-gray-400 text-sm">No recent entries. Log your thoughts to keep track!</div>
            </div>

            <div class="text-center pt-5">
                <p class="text-gray-400">Keep adding your thoughts to gain deeper insights and track your progress.</p>
            </div>
        </Card>
    </div>
</template>
